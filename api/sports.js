...
module.exports=async function handler(req,res){
 ...
 try{
  ...
  if(leagueKey.startsWith('rugby-')){
   ...
   if(leagueKey==='rugby-top14'&&view==='standings'){const table=[['Lyon',3,3,0,0,47,14],['Toulouse',3,2,0,1,39,10],['Bordeaux-Bègles',3,2,0,1,53,10],['Pau',3,2,0,1,24,9],['Montpellier',3,2,0,1,43,9],['Bayonne',3,2,0,1,-19,9],['Castres',3,2,0,1,-3,8],['La Rochelle',3,2,0,1,-6,8],['Clermont',3,1,0,2,-17,5],['Perpignan',3,1,0,2,-25,5],['Stade Français',3,1,0,2,-37,4],['Racing 92',3,1,0,2,-66,4],['Toulon',3,0,0,3,-4,3],['Vannes',3,0,0,3,-29,0]].map((x,i)=>({rank:i+1,team:x[0],badge:'',played:x[1],win:x[2],draw:x[3],loss:x[4],gf:0,ga:0,gd:x[5],points:x[6]}));return res.status(200).json({league:leagueKey,view,table,source:'top14-current-2026-09-23'})}
