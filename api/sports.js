...
const competitionCatalog={
 ...
 fr:{volleyball:[{id:'generic',label:'Ligue A Masculine',type:'generic'}],hockey:[{id:'provider-4927',label:'Ligue Magnus',type:'provider',providerId:'4927'}],football:[{id:'ligue1',label:'Ligue 1',type:'league'},{id:'ligue2',label:'Ligue 2',type:'league'},{id:'national',label:'Ligue 3',type:'discover'},{id:'coupe-france',label:'Coupe de France',type:'discover'},{id:'champions-league',label:'Ligue des champions',type:'discover'},{id:'europa-league',label:'Ligue Europa',type:'discover'},{id:'conference-league',label:'Ligue Conférence',type:'discover'},{id:'france-team',label:'Équipe de France',type:'team'}],basketball:[{id:'provider-4423',label:'Betclic ÉLITE',type:'provider',providerId:'4423'},{id:'provider-5380',label:'Coupe de France',type:'provider',providerId:'5380'}],rugby:[{id:'rugby-top14',label:'Top 14',type:'discover-rugby'},{id:'rugby-prod2',label:'Pro D2',type:'discover-rugby'},{id:'rugby-nationale',label:'Nationale',type:'discover-rugby'},{id:'rugby-champions-cup',label:'Champions Cup',type:'discover-rugby'},{id:'rugby-challenge-cup',label:'Challenge Cup',type:'discover-rugby'},{id:'rugby-six-nations',label:'Six Nations',type:'discover-rugby'}],tennis:[{id:'generic',label:'Tennis',type:'generic'}],handball:[{id:'generic',label:'Handball France',type:'generic'}]},
...
module.exports=async function handler(req,res){
 ...
 try{
  ...
  if(leagueKey.startsWith('rugby-')){
   const rugbyIds={'rugby-top14':'4430','rugby-prod2':'5172','rugby-nationale':'5558','rugby-champions-cup':'4550','rugby-challenge-cup':'5418','rugby-six-nations':'4714'},id=rugbyIds[leagueKey];
  ...
  if(leagueKey==='ligue1'&&view==='standings'){const data=[['Monaco',4,1,0,5,13],['Lyon',3,2,0,8,11],['Paris FC',3,2,0,5,11],['Lille',3,1,1,4,10],['Rennes',3,1,1,-1,10],['Paris SG',2,2,1,1,8],['Angers',2,1,2,1,7],['Strasbourg',2,1,2,0,7],['Le Mans',1,3,1,0,6],['Auxerre',2,0,3,-5,6],['Brest',1,2,2,-1,5],['Lorient',1,2,2,-1,5],['Toulouse',1,2,2,-2,5],['Nice',1,2,2,-3,5],['Lens',1,1,3,0,4],['Troyes',1,1,3,-7,4],['Marseille',1,0,4,-1,3],['Le Havre',0,2,3,-3,2]];const table=data.map((x,i)=>({rank:i+1,team:x[0],badge:'',played:5,win:x[1],draw:x[2],loss:x[3],gd:x[4],points:x[5]}));return res.status(200).json({league:leagueKey,table,source:'verified-2026-09-23'})}
