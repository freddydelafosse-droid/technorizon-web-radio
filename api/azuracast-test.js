...
export default async function handler(req,res){
 ...
 try{
  ...
  const t=await fetch("https://api.elevenlabs.io/v1/text-to-speech/"+VOICE,{method:"POST",headers:{"xi-api-key":el,"Content-Type":"application/json","Accept":"audio/mpeg"},body:JSON.stringify({text,model_id:"eleven_multilingual_v2",voice_settings:{speed:isEditorial?0.95:0.96,stability:isEditorial?0.34:0.27,similarity_boost:0.80,style:isEditorial?0.34:0.52,use_speaker_boost:true}})});
